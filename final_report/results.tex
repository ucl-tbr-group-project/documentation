...
seem to confirm our expectations. Compared to the previous experiment, we observe
...
affected models appear to be gradient boosted trees, artificial neural networks and extremely
randomised trees, which are known to be capable of capturing relationships
...
time. While extremely randomised trees and radial basis functions also
demonstrated satisfactory properties, other families failed to achieve
comparable regression performance, and in some cases also prediction time.
...
methods based on decision trees and artificial neural networks offer the best regression performance on
