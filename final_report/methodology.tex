...
The unsupervised setting can be viewed as a more general problem.
...
% TODO: mark instances that timed out in results
...
the third experiment, the 20~best-performing hyperparameter choices of each class
