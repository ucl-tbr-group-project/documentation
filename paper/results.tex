...
\begin{figure}
	\centering
	\hspace*{-1.4em}\includegraphics[width=1.15\linewidth]{fig7_qasssampling_new.pdf}
	\caption{\label{fig:qasssampling}Absolute training error for QASS, baseline scheme, and mixed scheme.}
\end{figure}

\begin{figure}
	\centering
	\hspace*{-1.4em}\includegraphics[width=1.15\linewidth]{fig8_qasssampling100k_new.pdf}
