...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{fig4_qassplan.png}
...
each drawn according to the same symmetric proposal
distribution\todo{Incorporate the footnote into the text.}\footnote{An
