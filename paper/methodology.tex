...
of this work, in particular Experiments~1 \&~2 that are outlined
...
The objective of the Experiment~1 is to simplify the regression task for
...
Experiment~2 conventionally measures surrogate performance on the full,
...
investigate their scaling properties. Following that, Experiment~4 aims
