...
\footnotetext[1]{A bug in the Muir distribution involving erronous normal sampling was recently uncovered (see https://github.com/openmc-dev/openmc/pull/1670), but is disregarded in the present approach-focused work.}
